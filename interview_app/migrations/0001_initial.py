# Generated by Django 3.0.5 on 2021-07-15 05:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualification', models.ForeignKey(help_text='select a highest qualification you have done', on_delete=django.db.models.deletion.CASCADE, to='interview_app.Degree')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ManyToManyField(to='interview_app.Employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interview_app.Employee')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='employee',
            name='specialization',
            field=models.ForeignKey(help_text='select a subject of specialization', on_delete=django.db.models.deletion.CASCADE, to='interview_app.Subject'),
        ),
        migrations.CreateModel(
            name='Documents',
            fields=[
